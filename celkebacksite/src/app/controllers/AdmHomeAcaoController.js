...
class AdmHomeAcaoController {

    async show(req, res) {
        Home.findOne({}, "_id acaoTitulo acaoSubtitulo acaoDesc acaoTextBtn acaoLinkBtn").then((home) => {
            return res.json({
                error: false,
                home: home
            });
    ...
    async update(req, res) {
        ...
        const schema = Yup.object().shape({
            acaoTitulo: Yup.string()
                .required(),
            acaoSubtitulo: Yup.string()
                .required(),
            acaoDesc: Yup.string()
                .required(),
            acaoTextBtn: Yup.string()
                .required(),
            acaoLinkBtn: Yup.string()
                .required()
        });
...
export default new AdmHomeAcaoController();